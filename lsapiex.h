...
namespace LiteStep {
	void GetPrefixedRCString(char *szDest, const char *szPrefix, const char *szOption, const char *szDefault);
	void GetPrefixedRCLine	(char *szDest, const char *szPrefix, const char *szOption, const char *szDefault);
